...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" id="links" class="tab-pane fade in active">
            ...
            <legend><?= __("Short Link Page External Integration") ?></legend>

            <div class="row">
                <div class="col-sm-2"><?= __('Integration Type') ?></div>
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['external_integration_type']['id'] . '.value', [
                        'label' => false,
                        'options' => [
                            'none' => __('None'),
                            'pressfly' => __('PressFly'),
                            'wordpress' => __('WordPress'),
                        ],
                        'value' => $settings['external_integration_type']['value'],
                        //'empty'   => __( 'Choose' ),
                        'class' => 'form-control',
                    ]);
                    ?>
            ...
            <div class="conditional"
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <?=
                        $this->Form->control('Options.' . $settings['pressfly_access_url']['id'] . '.value', [
                            'label' => false,
                            'class' => 'form-control',
                            'type' => 'text',
                            'value' => $settings['pressfly_access_url']['value'],
                        ]);
                        ?>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <?=
                        $this->Form->control('Options.' . $settings['pressfly_secret_key']['id'] . '.value', [
                            'label' => false,
                            'class' => 'form-control',
                            'type' => 'text',
                            'value' => $settings['pressfly_secret_key']['value'],
                        ]);
                        ?>
                    </div>
                </div>
            ...
            <div class="conditional"
                ...
                <div class="row">
                    <div class="col-sm-2"><?= __('WordPress Access URL') ?></div>
                    <div class="col-sm-10">
                        <?=
                        $this->Form->control('Options.' . $settings['wordpress_access_url']['id'] . '.value', [
                            'label' => false,
                            'class' => 'form-control',
                            'type' => 'text',
                            'value' => $settings['wordpress_access_url']['value'],
                        ]);
                        ?>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-2"><?= __('WordPress Secret Key') ?></div>
                    <div class="col-sm-10">
                        <?=
                        $this->Form->control('Options.' . $settings['wordpress_secret_key']['id'] . '.value', [
                            'label' => false,
                            'class' => 'form-control',
                            'type' => 'text',
                            'value' => $settings['wordpress_secret_key']['value'],
                        ]);
                        ?>
                    </div>
                </div>
        ...
        <div role="tabpanel" id="earnings" class="tab-pane fade in">
            ...
            <div class="row conditional" data-cond-option="Options[<?= $settings['enable_referrals']['id'] ?>][value]"
                ...
                <div class="col-sm-10">
                    <?=
                    $this->Form->control('Options.' . $settings['referral_percentage']['id'] . '.value', [
                        'label' => false,
                        'class' => 'form-control',
                        'type' => 'number',
        ...
        <div role="tabpanel" id="captcha" class="tab-pane fade in">
            ...
            <div class="conditional" data-cond-option="Options[<?= $settings['captcha_type']['id'] ?>][value]"
                 data-cond-value="turnstile">

                <legend><?= __('Turnstile Settings') ?></legend>

                <div class="row">
                    <div class="col-sm-2"><?= __('Turnstile Site key') ?></div>
                    <div class="col-sm-10">
                        <?=
                        $this->Form->control('Options.' . $settings['turnstile_site_key']['id'] . '.value', [
                            'label' => false,
                            'class' => 'form-control',
                            'type' => 'text',
                ...
                <div class="row">
                    <div class="col-sm-2"><?= __('Turnstile Secret key') ?></div>
                    <div class="col-sm-10">
                        <?=
                        $this->Form->control('Options.' . $settings['turnstile_secret_key']['id'] . '.value', [
                            'label' => false,
                            'class' => 'form-control',
                            'type' => 'text',
