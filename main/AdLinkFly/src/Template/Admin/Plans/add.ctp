...
<div class="box box-primary">
    <div class="box-body">
        ...
        <span class="help-block">
            <?= __(
                'Only admins can see hidden plans and assign it to users but users will not see it at the member area.'
            ) ?>
        </span>
        ...
        <table class="table table-hover table-striped">
            <tr>
                <td>
                    ...
                    <span
                        class="help-block"><?= __(
                            "How many seconds for the countdown timer into the short link page?"
                        ) ?></span>
                </td>
                <td>
                    <?=
            ...
            <tr>
                <td>
                    ...
                    <span class="help-block">
                        <?= __(
                            "You need to enable interstitial and banner to allow users to select random redirect type.."
                        ) ?>
                    </span>
                </td>
            ...
            <tr>
                <td>
                    ...
                    <span class="help-block"><?= __(
                            "Enabling this feature will allow short link creator " .
                            "to edit his links but without editing the long URL."
                        ) ?></span>
                </td>
            ...
            <tr>
                <td>
                    ...
                    <span class="help-block">
                        <?= __(
                            "Enabling this feature will allow short link creator to edit the long URL " .
            ...
            <tr>
                <td>
                    ...
                    <span class="help-block">
                        <?= __(
                            "Enabling this feature will allow short link creator to add a custom alias " .
                            "when shorten a url."
                        ) ?>
                    </span>
                </td>
            ...
            <tr>
                <td>
                    ...
                    <span class="help-block">
                        <?= __(
                            "Enabling this feature will allow short link creator to set an expiration date/time" .
            ...
            <tr>
                <td>
                    ...
                    <span class="help-block">
                        <?= __(
                            "Enabling this feature will allow short link creator to select a different " .
            ...
            <tr>
                <td>
                    ...
                    <span class="help-block"><?= __(
                            "Enabling this feature will allow the logged in visitors " .
                            "who are on this plan not to show the ads on short link page and member area."
                        ) ?></span>
                </td>
            ...
            <tr>
                <td>
                    ...
                    <span class="help-block"><?= __(
                            "Enabling this feature will allow the logged in visitors " .
                            "to escape the captcha step and see the short link page directly."
                        ) ?></span>
                </td>
            ...
            <tr>
                <td>
                    ...
                    <span class="help-block"><?= __(
                            "Enabling this feature will allow the short link visitors " .
                            "to escape the captcha step and see the short link page directly."
                        ) ?></span>
                </td>
                <td><label class="switch"><?= $this->Form->checkbox(
                            'visitors_remove_captcha',
                            ['required' => false]
                        ); ?><span
                            class="slider round"></span></label></td>
            </tr>
            ...
            <tr>
                <td>
                    ...
                    <span class="help-block"><?= __(
                            "Enabling this feature will allow the logged in visitors " .
                            "to go to directly the long URL without seeing the short link page."
                        ) ?></span>
                </td>
        ...
        <p>* <?= __(
                "This feature requires the visitor to the short link to be logged in then this feature " .
                "will take effect."
            ) ?></p>
    </div>
</div>
